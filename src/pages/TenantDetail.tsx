...
import { Copy, ExternalLink, CalendarIcon, ChevronDown, Mail, Link2, RotateCcw, Check, Loader2 } from "lucide-react";
...
export default function TenantDetail() {
  ...
  const saveChanges = async () => {
    ...
    if (editExpires && editExpires.toISOString() !== tenant.expires_at) { changes.expires_at = editExpires.toISOString(); }
