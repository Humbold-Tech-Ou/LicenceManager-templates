    ...
    Tables: {
      ...
      tenants: {
        Row: {
          ...
          deploy_access_token: string | null
          ...
          deploy_refresh_token: string | null
          deploy_team_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "tenants_panel_version_id_fkey"
            columns: ["panel_version_id"]
            isOneToOne: false
            referencedRelation: "panel_versions"
            referencedColumns: ["id"]
          },
        ]
      }
