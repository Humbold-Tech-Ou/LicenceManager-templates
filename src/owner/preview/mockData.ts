// AUTO-GENERATED by seed-template-preview — preview-only mock data
import type {
...
export const mockActiveConnections = [
  { id: "c-1", line_id: "l-1", ip: "190.12.4.55",  user_agent: "Smart TV", connected_at: iso(0) },
  { id: "c-2", line_id: "l-3", ip: "200.10.50.11", user_agent: "Android",  connected_at: iso(0) },
];
