...
export const mockVod: VodItem[] = [
  { id:"v-1", server_id:"s-2", tmdb_id:603,  type:"movie",  title:"The Matrix",
    ...
    trailer_url:null, seasons:null, stream_url:null, active:true, created_at:iso(-30) },
  { id:"v-2", server_id:"s-2", tmdb_id:1399, type:"series", title:"Game of Thrones",
    ...
    trailer_url:null, seasons:8, stream_url:null, active:true, created_at:iso(-25) },
  { id:"v-3", server_id:"s-2", tmdb_id:680,  type:"movie",  title:"Pulp Fiction",
    ...
    trailer_url:null, seasons:null, stream_url:null, active:true, created_at:iso(-20) },
  { id:"v-4", server_id:"s-2", tmdb_id:1396, type:"series", title:"Breaking Bad",
    ...
    trailer_url:null, seasons:5, stream_url:null, active:true, created_at:iso(-15) },
];
