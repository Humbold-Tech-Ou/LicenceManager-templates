...
export function PreviewProvider({ children }: { children: ReactNode }) {
  // Install the mock client only when a preview route actually mounts.
  // Doing this at module top-level would leak the mock into real /owner/* routes
  // when this file is imported by App.tsx, causing tenants to see demo data.
  useState(() => {
